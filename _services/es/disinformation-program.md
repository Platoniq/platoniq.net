...
{% metrics { "items": [{"text":"Pensamiento crítico"},{"text":"Alfabetización digital"},{"text":"Toolkit digital"},{"text":"Capacitación profesorado"},{"text":"Creatividad contra la desinformación"},{"text":"Lucha contra la desinformación"}] } %}
